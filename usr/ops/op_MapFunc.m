...
%------- PQ 9ns NTC interval ------
%1det_33C_9ns: '@(x)233.97304.*((0.07434-x)./(x-0.37527)).^(1/1.08896)'
%1det_33C_9ns: '@(x)181.39721.*((0.08885-x)./(x-0.38816)).^(1/1.25546)'
% --- OGB2 ---
%------- PQ 9ns NTC interval ------
...
%1det_34C__UG_9ns: '@(x)146.58*((0.09048-x)./(x-0.32)).^(1/1.03059)'
%1det_34C__UG_9ns:
%'@(x)139.06885*((0.08921-x)./(x-0.37016)).^(1/0.99636)'(KAI)
...
parameters=struct('note','',...
    ...
    'disp_lb',20,...
    'disp_ub',100,...
    'calib_func','@(x)146.58*((0.09048-x)./(x-0.32)).^(1/1.03059)');

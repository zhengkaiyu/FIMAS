                    ...
                    case 'histogram'
                        ...
                        switch bin2dec(num2str(pos_dim_idx))%display decide on data dimension
                            ...
                            case {1,2,4,8,16}
                                ...
                                data{1}=linspace(obj.data(current_data).datainfo.(fname)(1).*maxval,...
                                    obj.data(current_data).datainfo.(fname)(2).*maxval,...
                                    obj.data(current_data).datainfo.(fname)(3).*maxval);
                                [data{2},~]=histc(obj.data(current_data).dataval(:),data{1});
                            case 9
                                %XT(01001)
                                maxval=nanmax(obj.data(current_data).dataval(pixel_idx));
                                data{1}=linspace(obj.data(current_data).datainfo.t_disp_bound(1).*maxval,...
                                    obj.data(current_data).datainfo.t_disp_bound(2).*maxval,...
                                    obj.data(current_data).datainfo.t_disp_bound(3).*maxval);
                            ...
                            case 28
                                ...
                                maxval=nanmax(temp(:));
                                data{1}=linspace(obj.data(1).datainfo.Z_disp_bound(1).*maxval,...
                                    obj.data(1).datainfo.Z_disp_bound(2).*maxval,...
                                    obj.data(1).datainfo.Z_disp_bound(3));
